...
const blockElements = new Set(["proxycanvas", "shadowroot", "style", "flutter-view", "flt-glass-pane", "flt-text-editing-host", "flt-semantics-host", "flt-scene", "flt-scene-host", "flt-semantics-placeholder", "flt-announcement-polite", "flt-announcement-assertive", "flt-canvas-container", "body", "svg", "address", "fieldset", "li", "span", "article", "figcaption", "main", "aside", "figure", "nav", "blockquote", "footer", "ol", "details", "p", "dialog", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "dd", "header", "section", "div", "hgroup", "table", "dl", "hr", "ul", "dt", "view", "view-block"]);
