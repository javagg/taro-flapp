...
import { TextPaintService } from "../mmtex/paint_service";
import { ParagraphLine, RootStyleNode, StyleNode } from "../mmtex/paragraph";
import { WordBreaker } from "../mmtex/word_breaker";
...
export class _Paragraph extends SkEmbindObject<"Paragraph"> implements Paragraph {
    ...
    getNumberOfLines(): number {
        throw new Error("getNumberOfLines")
