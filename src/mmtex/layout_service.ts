...
import { TextPosition, GlyphInfo, ParagraphConstraints } from './paragraph';
...
export class TextLayoutService {
    ...
    performLayout(constraints: ParagraphConstraints): void {
        ...
        this._layoutFragments(constraints);
    }
     ...
     */
    private _layoutFragments(constraints: ParagraphConstraints): void {
        ...
        for (let i = 0; i < this._fragments.length; i++) {
            ...
            if (currentLineWidth + fragment.width > constraints.width ||
...
//     interface Window {
//       textContext: any;
//       _lastContextFont: string | null;
//     }
//   }
//   window.textContext = null;
//   window._lastContextFont = null;