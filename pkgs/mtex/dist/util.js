...
// };
export const colorToHex = (rgbaColor) => {
...
export const valueOfRGBAInt = (r, g, b, a) => {
    return Float32Array.from([r, g, b, a]);
};
export const valueOfRectXYWH = (x, y, w, h) => {
    return Float32Array.from([x, y, x + w, y + h]);
};
export function isEnglishWord(str) {
    const englishRegex = /^[A-Za-z,.]+$/;
    const result = englishRegex.test(str);
    return result;
}
export function isSquareCharacter(str) {
...
export function convertToUpwardToPixelRatio(number, pixelRatio) {
